    ...
    <PageBase buttonBack backLink="/ecosystem">
      <div className="px-6 py-8">
        ...
        <div className="text-celestial text-sm font-medium pr-14 pb-24">
          Ferritin is a blood protein that contains iron. A ferritin test helps
          your doctor understand how much iron your body stores. If a ferritin
          test reveals that your blood ferritin level is lower than normal, it
          indicates your body iron stores are low and you have iron deficiency.
        </div>
        <div className="pb-12">
        ...
        <div className="text-sm font-medium pb-20">
          XYZ Analytics will use this data exclusively to deliver insights to
          you
        </div>
        <button
