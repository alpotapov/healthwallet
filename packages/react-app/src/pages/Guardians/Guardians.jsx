              ...
              <div className="flex justify-between items-start pb-8 mt-5">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-lilac">
                    Here you can appoint your HealthWallet guardians. Those be
                    the people you trust - your family members or close friends.
            ...
            <div className="w-full px-6">
              <div className="flex justify-between items-start pb-8 mt-5">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-lilac">
                    If you lose your device or your private key - guardians be
                    able to restore access to your medical history.
                  </div>
                </div>
              </div>
              <div className="flex items-center w-full bg-blueberry h-14 px-5 rounded-3xl mt-6 mb-5">
